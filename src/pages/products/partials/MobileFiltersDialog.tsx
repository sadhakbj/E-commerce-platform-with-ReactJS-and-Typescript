...
const MobileFiltersDialog = (props: Props) => {
  return (
    <Transition.Root show={props.mobileFiltersOpen} as={Fragment}>
      <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={() => props.setMobileFiltersOpen(false)}>
        <Transition.Child
          as={Fragment}
        ...
        >
          <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
            ...
            <form className="mt-4 border-t border-gray-200">
              ...
              {filters.map((section) => (
                <Disclosure defaultOpen={true} as="div" key={section.id} className="border-t border-gray-200 px-4 py-6">
                  {({ open }) => (
                    <>
